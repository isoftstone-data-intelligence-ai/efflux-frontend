...
export function getModelClient(model: LLMModel, config: LLMModelConfig) {
  ...
  const providerConfigs = {
    ...
    azure: () => {
      // 接入 自己的模型
      return createAzure({
        //  apiKey:'c70ec31c1d794452a5e18eefb0e72781',
        // baseURL:'https://isfot-ai.openai.azure.com/openai/deployments',
        apiKey: apiKey || process.env.AZURE_API_KEY,
        baseURL: baseURL || 'https://isfot-ai.openai.azure.com/openai/deployments',
